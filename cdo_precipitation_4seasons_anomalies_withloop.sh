...
#4 seasons
#Birak s:December-January (12/01)
#season="birak"
...
#did summer separately because that needs seassum and the others can use yearsum
...
cdo -yearsum -select,season=${seasons_months[$i]} $input_file $seasonal_output
