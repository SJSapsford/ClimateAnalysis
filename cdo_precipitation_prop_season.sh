...
# step 1:
##### Inputs ########################### 
input_file_diff="/Programs/Climate/processed/Precipitation/agcd_v2_precip_winter_1993_2022_minus_1961_1990.nc"
input_file_hist="/Programs/Climate/processed/Precipitation/agcd_v2_precip_wintertimmean_1961_to_1990.nc"
...
#definte output file
winter_diff_prop=${output_dir}agcd_v2_precip_winter_prop_${cyear_in}_${cyear_out}_minus_${hyear_in}_${hyear_out}.nc
