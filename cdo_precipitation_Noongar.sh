...
##### Inputs ###########################
input_file="/data/Climate/agcd_v2_precipt_Noongar_monthly_ALL.nc" 
...
month_start="04"
month_end="05"
output_dir="/data/Climate/processed/Precipitation/NoongarSeasons/"
########################################
# code starts here
...
cdo -yearsum -select,season=AS ${input_file} ${file_out_winter}
